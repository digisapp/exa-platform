...
const QUICK_PRESETS = [
  ...
  },
  {
    ...
    deliverables: "• Full Get Ready With Me video (15–30 min)\n• My real hair, makeup & outfit routine\n• Delivered privately to winner within 7 days\n• Never posted publicly",
    category: "custom_content" as AuctionCategory,
    suggestedPrice: "300",
  },
  {
    ...
    deliverables: "• 1 reformer pilates class together in Miami\n• Scheduled at a mutual time within 30 days\n• Winner books the studio",
  ...
  },
  {
    emoji: "💅",
    label: "Beauty Day",
    title: "Beauty Day Out with Me",
    description: "Win a full beauty day with me — nails, lashes, blowout, whatever we're feeling. Perfect for the girls who want a fun day of self-care and great company.",
    deliverables: "• Half-day beauty outing together in Miami\n• Nails, lashes, hair — winner's choice\n• Scheduled at a mutual time within 30 days",
    category: "experience" as AuctionCategory,
    suggestedPrice: "600",
  },
  {
