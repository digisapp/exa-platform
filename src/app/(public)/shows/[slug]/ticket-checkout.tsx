...
> = {
  ...
  "May 28": {
    ...
    subtitle: "Doors 6pm · Show 7pm · Iconic sand runway at sunset",
    badge: "Beach Runway",
  ...
  "May 31": {
    ...
    subtitle: "Doors 6pm · Show 7pm · DJ set + after party",
    badge: "Closing Party",
    badgeGradient: "from-cyan-500 to-pink-500",
    gradient: "from-cyan-500/20 via-pink-500/10 to-transparent",
