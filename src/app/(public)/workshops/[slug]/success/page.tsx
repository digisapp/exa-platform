        ...
        <Card className="text-center">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-2xl">
              {loading ? "Processing..." : "You're Registered!"}
            </CardTitle>
            ...
            {!loading && (
              <>
                ...
                <div className="space-y-4 pt-4">
                  <div className="p-4 rounded-xl bg-muted/50 space-y-3">
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span>
                        Confirmation email with workshop details has been sent
                      </span>
                    </div>
                    <div className="flex items-center gap-3 text-sm">
                    ...
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span>Location details included in your email</span>
                    </div>
                  </div>

                  <div className="p-4 rounded-xl bg-pink-500/10 border border-pink-500/20">
                    <p className="text-sm text-pink-200">
                      <strong>Get Ready!</strong> Don&apos;t forget to bring comfortable
                      practice heels and form-fitting workout attire. We can&apos;t
                      wait to see you there!
                    </p>
                  </div>

                  <p className="text-sm text-muted-foreground">
                    Check your inbox (and spam folder) for your registration
                    confirmation.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 pt-4">
                  ...
                  >
                    <Link href="/workshops">View More Workshops</Link>
                  </Button>
                </div>
              </>
            )}
