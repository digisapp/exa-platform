...
export function showTipSuccessToast({ amount, recipientName }: TipToastProps) {
  toast.custom(
    (t) => (
      <div
        className="relative animate-in zoom-in-95 fade-in duration-300 cursor-pointer mx-auto"
      ...
      >
        ...
        {/* Toast content */}
        <div className="relative bg-gradient-to-br from-pink-500/90 to-violet-600/90 backdrop-blur-xl text-white px-8 py-5 rounded-2xl shadow-2xl border border-white/20">
          {/* Sparkles decoration */}
