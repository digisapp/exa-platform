...
export async function sendTravelPartnershipEmail({
  ...
  try {
    ...
    const deliverables: Array<[string, string, string]> = [
      ["📸", "Professional Photos", "High-quality images across your rooms, pool, restaurant, and common areas"],
      ["🎬", "TikTok & Instagram Reels", "Authentic short-form content that shows the lifestyle your guests experience"],
      ["📲", "Instagram Stories", "Real-time engagement with swipe-up links to your booking page"],
      ["📡", "Live Streaming", "Real-time content broadcast to our audience during the stay"],
    ];
