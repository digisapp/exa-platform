-- Micro-tips: lower minimum to 1 coin, system messages only for big tips (>= 10)
-- New glow tiers: 10+ amber | 50+ gradient | 100+ animated

-- ============================================
-- Relax the CHECK constraint on live_wall_tips
-- ============================================
ALTER TABLE public.live_wall_tips DROP CONSTRAINT IF EXISTS live_wall_tips_amount_check;
ALTER TABLE public.live_wall_tips ADD CONSTRAINT live_wall_tips_amount_check CHECK (amount >= 1);

-- ============================================
-- Replace atomic tip function with micro-tip support
-- ============================================
...
BEGIN
  ...
  -- Lock and read tipper balance + display name
