/**
 * Same-day reminder: Runway training Friday May 29, 2026 at 11:00 AM
 * at The Alexander Hotel Miami Beach.
 *
 * Usage:
 *   npx tsx scripts/send-runway-training-reminder-may29.ts                 # dry run
 *   npx tsx scripts/send-runway-training-reminder-may29.ts --send          # live, full list
 *   npx tsx scripts/send-runway-training-reminder-may29.ts --test --send   # live, single test email
 */
...
const TRAINING_DAY = "Friday";
const TRAINING_TIME = "11:00 AM";
...
const RECIPIENTS: Recipient[] = [
  { name: "Angela Dong", email: "angeladong123@yahoo.com" },
  { name: "Angelina Morris", email: "angelina_morris@icloud.com" },
  { name: "Arina Ilyushina", email: "arinamoranz@gmail.com" },
  { name: "Avary Lynne", email: "shoultsavary@gmail.com" },
  { name: "Cassandra Hrabik", email: "hrabikc@icloud.com" },
  { name: "Chloe Kofoed", email: "chloedkofoed@gmail.com" },
  { name: "Daryana Campusano", email: "daryana.j@gmail.com" },
  { name: "Donatella Barbero", email: "dabarbero10@gmail.com" },
  { name: "Elektra Rice", email: "e233122a@gmail.com" },
  { name: "Emma Jordan", email: "emma.jordan1717@gmail.com" },
  { name: "Erika Nicole", email: "fitbyerikanicole@gmail.com" },
  { name: "Gabbi Garrett", email: "gabbiigarrett@gmail.com" },
  { name: "Ivanna Cuesta", email: "ivannac74@gmail.com" },
  { name: "Jazmine Salazar", email: "jazminemsal@gmail.com" },
  { name: "Jessica Tomas", email: "jessicatomas2709@gmail.com" },
  { name: "Joanna Hartwig", email: "joannahartwig57@gmail.com" },
  { name: "Kadeitra Renae", email: "kadeitrawells@gmail.com" },
  { name: "Maggie Romeo", email: "maggie.romeoo@gmail.com" },
  { name: "Miah Daniels", email: "miahdaniels04@icloud.com" },
  { name: "Misty Hartman", email: "mistyhartman30@me.com" },
  { name: "Natalie Eberhardt", email: "eberhardtnn@yahoo.com" },
  { name: "Nicole Alexakis", email: "nicolealexakis@outlook.com" },
  { name: "Sarah Alkhoury", email: "sarahmarie.alkhoury@gmail.com" },
  { name: "Tamia Godwin", email: "miaxoxo79@gmail.com" },
];
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #ec4899 0%, #8b5cf6 60%, #06b6d4 100%); padding: 44px 30px; text-align: center;">
              <p style="margin: 0 0 12px; color: rgba(255,255,255,0.95); font-size: 11px; font-weight: 800; letter-spacing: 4px; text-transform: uppercase;">
                Reminder · ${escapeHtml(TRAINING_DAY)}
              </p>
              ...
              <p style="margin: 14px 0 0; color: rgba(255,255,255,0.92); font-size: 15px;">
                ${escapeHtml(TRAINING_DAY)} · ${TRAINING_TIME}
              </p>
            </td>
          </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td style="padding: 0 0 20px; color: #ffffff; font-size: 17px; font-weight: 600;">
                          ${escapeHtml(TRAINING_DAY)} · ${TRAINING_TIME} (this morning)
                        </td>
                      </tr>
                      <tr>
...
Time: ${TRAINING_DAY} · ${TRAINING_TIME} (this morning)
...
async function main() {
  ...
  console.log(`  ${TRAINING_DAY} · ${TRAINING_TIME}`);
  ...
  for (const r of recipients) {
    try {
      const { data, error } = await resend.emails.send({
        ...
        to: [r.email],
        subject: "Reminder: Runway training Friday at 11 AM — The Alexander Hotel",
