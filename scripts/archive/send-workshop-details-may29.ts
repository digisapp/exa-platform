 ...
 * for the Friday May 29, 2026 session (11AM–2PM · The Alexander Hotel).
 *
 * Usage:
 *   npx tsx scripts/send-workshop-details-may29.ts                 # dry run
 *   npx tsx scripts/send-workshop-details-may29.ts --send          # live, full list
 *   npx tsx scripts/send-workshop-details-may29.ts --test --send   # live, single test email to miriam@examodels.com
 */
...
const WORKSHOP_DATE = "Friday, May 29, 2026";
const WORKSHOP_TIME = "11:00 AM – 2:00 PM";
...
const RECIPIENTS: Recipient[] = [
  ...
  { name: "Kamryn", email: "kamccall00@gmail.com" },
