 ...
 * for the Wednesday May 27, 2026 session (11AM–2PM · The Alexander Hotel).
 *
 * Usage:
 *   npx tsx scripts/send-workshop-details-may27.ts                 # dry run
 *   npx tsx scripts/send-workshop-details-may27.ts --send          # live, full list
 *   npx tsx scripts/send-workshop-details-may27.ts --test --send   # live, single test email to miriam@examodels.com
 */
...
const WORKSHOP_DATE = "Wednesday, May 27, 2026";
