        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: *.supabase.co *.cdninstagram.com www.google.com *.gstatic.com img.youtube.com imgen.x.ai",
              "font-src 'self' fonts.gstatic.com data:",
              "connect-src 'self' data: blob: *.supabase.co wss://*.supabase.co *.livekit.cloud wss://*.livekit.cloud api.stripe.com *.upstash.io imgen.x.ai translate.googleapis.com",
